...
export function Tunnel5({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    ...
    >
      ...
      {/* Pulsing white light at vanishing point before explosion */}
      {phase === "rushing" && pulseIntensity > 0 && (
        <motion.div
          ...
          animate={{
            width: `${pulseIntensity * 200}px`,
            height: `${pulseIntensity * 200}px`,
            opacity: pulseIntensity * 0.9,
            boxShadow: `0 0 ${pulseIntensity * 150}px ${pulseIntensity * 80}px rgba(255, 255, 255, ${pulseIntensity * 0.8})`,
          }}
